import aThousandShips from "./src/img/athousandship.webp";
import aWholeLife from "./src/img/awholelife.webp";
import happiestMan from "./src/img/happiestman.webp";
import luster from "./src/img/luster.jpg";
import room from "./src/img/room.webp";
import sherlockHome from "./src/img/sherlockhome.webp";
import shining from "./src/img/shinning.webp";
import sparrow from "./src/img/sparrow.webp";
import fourWind from "./src/img/thefourthwind.webp";
...
const bookList = [
  {
    ...
    description:
      "A must-read retelling of one of the most significant conflicts in history, in A Thousand Ships Natalie Haynes puts the women at the centre of the story of the Trojan War for the first time. Charting the fates of the Trojan women who had to adapt to defeat and live under the Greeks, to the women who proved the catalyst for war, Haynes breathes new life into the classic tale in this compellingly readable novel. ",
  },
  {
    id: 2,
    src: aWholeLife,
  ...
  },
  {
    ...
    description:
      "One of Barack Obama’s Favourite Books of 2020, Raven Leilani's razor-sharp yet surprisingly tender debut is an essential novel about what it means to be young now. Edie is messing up her life. She’s messing up in her dead-end admin job in her all-white office, she's sleeping with all the wrong men and has failed at the only thing that meant anything to her, painting. Then she meets Eric, who is white, middle-aged and comes with a wife who has sort-of-agreed to an open marriage and an adopted black daughter who doesn’t have a single person in her life who can show her how to do her hair. And as if life wasn’t hard enough, Edie finds herself falling head-first into Eric’s family. ",
  },
  {
    id: 5,
    src: room,
    ...
    description:
      "Shortlisted for both the Booker Prize and the Women’s Prize for fiction, Room is a unique novel, about survival, innocence and the bond behind mother and son. We hear the story through Jack's voice – he lives with his Ma in Room, which has a locked door and a skylight, and measures 11 feet by 11 feet. He loves watching TV, and the cartoon characters he calls friends, but he knows that nothing he sees on screen is truly real – only him, Ma and the things in Room. Until the day Ma admits that there’s a world outside. Emma Donoghue's novel is both devastating and uplifting and has also been adapted for film, which won the Best Actress Oscar for Brie Larson. ",
  },
  {
    id: 6,
    src: sherlockHome,
